...
<template>
  <div id='App'>
    <fieldset>
      <div>
        <legend><h1>The Jokes Application</h1></legend>
          <table>
            <tr>
              <td>
                <a class='btnmenu' @click="selectDiv('1')">
                  Computer Stored Jokes
                </a>
              </td>
              <td>
                <a class='btnmenu' @click="selectDiv('2')">
                  User Generated jokes
                </a>
              </td>
              <td>
                <a class='btnmenu' @click="selectDiv('3')">
                  From a Joke Api
                </a>
              </td>
            </tr>
